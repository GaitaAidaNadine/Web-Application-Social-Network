    ...
    foreach( $condition as $secs => $str )
    {
        ...
        if( $d >= 1 )
        {
			...
			function displayTweets() {
				...
				$query="SELECT * FROM tweets ORDER BY datetime DESC LIMIT 30";
		...
		<div class="col-sm-4">
					...
					<br>
					<form class="form" action="includes/postTweet.inc.php" method="POST">
					<div class="form-group">
					<textarea class="form-control" id="tweetContent" name="tweet"></textarea>
					</div>
					<input type="hidden" name="submit" value="submit" />
					<button type="submit" id="postTweetButton" class="btn btn-primary" name="submit">Post Tweet</button>
					</form>
